...
import KemonitoGameModal from './KemonitoGameModal';

export default function Header() {
    // Estado para controlar nuestro minijuego
       ...
       <header className="header" id="header">
            <nav className="nav container">
                ...
                <div className="nav__btns">
                    {/* Botón de cambio de tema (Tu código actual) */}
                    <i className="uil uil-moon change-theme" id="theme-button"></i>

                    {/* NUEVO: Botón para abrir el minijuego */}
                    <span style={{ marginLeft: '1rem', cursor: 'pointer', fontSize: '1.25rem' }} onClick={() => setIsGameOpen(true)} title="Jugar Minijuego">🎮</span>
            ...
            {/* Renderizamos el modal si isGameOpen es true */}
            <KemonitoGameModal isOpen={isGameOpen} onClose={() => setIsGameOpen(false)} />
        </header>
    );
}
